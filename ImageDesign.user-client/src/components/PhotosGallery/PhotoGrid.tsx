...
import EmailShareDialog from './EmailShareDialog'; // הוסף את הייבוא
...
const PhotoGrid: React.FC<PhotoGridProps> = ({ photos, onPhotoClick, onCopyMoveClick, viewMode }) => {
    ...
    // הוסף פונקציה לטיפול בשיתוף תמונה
    const handleSharePhoto = (photo: Photo) => {
        setSelectedPhotoForEmail(photo);
        setEmailDialogOpen(true);
    };

    // הוסף פונקציה לסגירת דיאלוג המייל
    const handleEmailDialogClose = () => {
        setEmailDialogOpen(false);
        setSelectedPhotoForEmail(null);
    };
    ...
    if (viewMode === "grid") {
        return (
            <>
                ...
                {/* הוסף את דיאלוג המייל */}
                <EmailShareDialog
                    open={emailDialogOpen}
                    onClose={handleEmailDialogClose}
                    photo={selectedPhotoForEmail}
                />
            </>
        )
    }
    ...
    return (
        <>
                        ...
                        >
                            ...
                            <Box sx={{ display: "flex" }}>
                                ...
                                >
                                    ...
                                    <MenuItem
                                        onClick={() => {
                                            handleSharePhoto(photo); // עדכן גם כאן
                                            handleMenuClose(photo.id)
                                        }}
                                    >
                                        <ListItemIcon>
            ...
            {/* הוסף את דיאלוג המייל גם לתצוגה הקומפקטית */}
            <EmailShareDialog
                open={emailDialogOpen}
                onClose={handleEmailDialogClose}
                photo={selectedPhotoForEmail}
