...
using DotNetEnv; // ודא שהוספת את ה-using
...
namespace ImageDesign.API.Controllers
{
    ...
    public class ChatController : ControllerBase
    {
        ...
        {
            // קרא את ה-API Key מהקובץ ENV
            myApiKey = Env.GetString("API_KEY");
        }
        ...
        public async Task<IActionResult> Post([FromBody] GptRequest gptRequest)
        {
            try
            {
                // Prompt קבוע שמתמחה בשאלות על תמונות ועיבוד תמונות
                var systemPrompt = "אתה עוזר אישי של משתמשים, המיועד לספק תשובות לשאלות טכניות על תמונות ועיבוד תמונות.";
        ...
        new { role = "user", content = gptRequest.Question } // משתמש רק בשאלה
            }
                };
